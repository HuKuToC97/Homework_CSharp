...
//     pointofIntersection[1] = (tableOfEquation[2][2] - tableOfEquation[1][2]) / (tableOfEquation[1][1] - tableOfEquation[2][1]);
//     pointofIntersection[0] = (tableOfEquation[1][1] * pointofIntersection[1]+tableOfEquation[1][2]);
